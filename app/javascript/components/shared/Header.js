...
const Header = ({ namespace, month, year, ...props }) => {
  ...
  const selectedAccountPath = props.selectedAccountPath || ""
    ...
    <Row styling={{bgColor: "bg-blue-900", padding: "p-2", margin: "mb-2"}}>
      <Row styling={{bgColor: "bg-white"}}>
        <Cell styling={{width: "w-6/12", fontSize: "text-3xl", textAlign: "text-center"}}>
          <InertiaLink href={`/accounts/${selectedAccountPath}`} classes={["w-full"]}>
